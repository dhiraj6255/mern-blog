...
const RecentBlogs = () => {
    ...
    return (
        <div className='bg-gray-100 dark:bg-gray-800 pb-10 flex flex-col justify-center'>
            ...
            <div className="max-w-7xl mx-auto flex gap-6">
                ...
                <div className="bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10">
                    ...
                    <div className="my-5 flex flex-wrap gap-3">
                        {
                            ["Blogging", "Web Development", "Digital Marketing", "Cooking", "Photography", "Sports", "Traveling"].map((item, index) => {
                    ...
                    <p className='text-sm text-gray-600 dark:text-gray-400'>Get the latest posts and updates deliverd straight to your inbox</p>
                        ...
                        <ul className="space-y-3">
                            {
                                [
                                    ...
                                    return <li className='text-sm dark:text-gray-100 hover:underline cursor-pointer' key={index}>{title}</li>
                                })
                            }
                        </ul>
                    </div>
