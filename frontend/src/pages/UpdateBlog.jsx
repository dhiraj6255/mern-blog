...
const UpdateBlog = () => {
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            ...
            const res = await axios.put(`https://mern-blog-axdb.onrender.com/api/v1/blog/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnpublish = async () => {
        try {
            const res = await axios.patch(`https://mern-blog-axdb.onrender.com/api/v1/blog/${id}`, {
                withCredentials: true
            })
            if (res.data.success) {
                setPublish(!publish)
    ...
    const deleteBlog = async () => {
        try {
            const res = await axios.delete(`https://mern-blog-axdb.onrender.com/api/v1/blog/delete/${id}`, { withCredentials: true })
            if (res.data.success) {
