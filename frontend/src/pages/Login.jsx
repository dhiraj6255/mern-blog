...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('https://mern-blog-axdb.onrender.com/api/v1/user/login', input, { headers: { "Content-Type": "application/json" }, withCredentials: true })
            if (res.data.success) {
                navigate('/')
        ...
        <div className='flex min-h-screen md:pt-14 md:h-[760px] bg-cover bg-center relative' style={{ backgroundImage: `url(${auth})` }}>
            <div className="flex justify-center items-center flex-1 px-4 md:px-0">
                <Card className='w-full max-w-md p-6 shadow-lg rounded-2xl dark:bg-gray-800 dark:border-gray-600'>
                    <CardHeader>
                        <CardTitle>
                            <h1 className='text-center text-2xl font-semibold'>Login into your account</h1>
                        </CardTitle>
